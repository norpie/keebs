      ...
      in {
        default = pkgs.mkShellNoCC {
          ...
          shellHook = ''
            ...
            echo "ZMK development environment loaded!"
            echo "Run 'just init' to initialize the workspace"
            echo "Then 'just update' to fetch dependencies" 
            echo "Finally 'just build' to build firmware"
          '';
        };
      }
    );
